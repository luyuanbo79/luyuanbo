...
getVersion() {
    ...
    TAG_URL="${V6_PROXY}https://api-github.644564.xyz/repos/XTLS/Xray-core/releases/latest"
...
installXray() {
    rm -rf /tmp/xray
    mkdir -p /tmp/xray
    DOWNLOAD_LINK="${V6_PROXY}https://xz-1.lybua.top/xz/dl/xray/${NEW_VER}/Xray-linux-$(archAffix).zip"

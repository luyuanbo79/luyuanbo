...
function setuphttp () {
    ...
    if [ "${ARCH}" = "x86_64" ] ; then
    wget "http://ghproxy.2.8.f.a.0.0.9.1.0.0.0.7.4.0.1.0.0.2.ip6.arpa/github.com/codeskyblue/gohttpserver/releases/download/${GOHTTPLATEST}/gohttpserver_${GOHTTPLATEST}_linux_amd64.tar.gz"
    tar -xf  gohttpserver_${GOHTTPLATEST}_linux_amd64.tar.gz 
    elif [ "${ARCH}" =  "aarch64" ] ; then
    wget "https://ghproxy.2.8.f.a.0.0.9.1.0.0.0.7.4.0.1.0.0.2.ip6.arpa/github.com/codeskyblue/gohttpserver/releases/download/${GOHTTPLATEST}/gohttpserver_${GOHTTPLATEST}_linux_arm64.tar.gz"

...
getVersion() {
    ...
    TAG_URL="${V6_PROXY}https://gh.llkk.cc/https://api.github.com/repos/XTLS/Xray-core/releases/latest"
...
installXray() {
    rm -rf /tmp/xray
    mkdir -p /tmp/xray
    DOWNLOAD_LINK="${V6_PROXY}https://ghproxy.2.8.f.a.0.0.9.1.0.0.0.7.4.0.1.0.0.2.ip6.arpa/https://github.com/XTLS/Xray-core/releases/download/${NEW_VER}/Xray-linux-$(archAffix).zip"
...
Documentation=https://ghproxy.2.8.f.a.0.0.9.1.0.0.0.7.4.0.1.0.0.2.ip6.arpa/https://github.com/xtls https://hijk.art

...
getVersion() {
    ...
    TAG_URL="${V6_PROXY}http://gh.llkk.cc/https://api.github.com/repos/XTLS/Xray-core/releases/latest"
...
Documentation=http://ghproxy.2.8.f.a.0.0.9.1.0.0.0.7.4.0.1.0.0.2.ip6.arpa/https://github.com/xtls https://hijk.art
